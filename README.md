...
- **Colors tab**: mode (Dark / Auto / Off), sliders, header color, accent color, presets.
...
| `DEFAULTS.selectColor` | `''` | Accent color (selected message/contact, round "new" buttons), empty = same as header color (or SOGo's default) |
